...
// https://www.man7.org/freebsd/man-pages/man7/bpf-helpers.7.html
...
bool is_helper_usable_freebsd(int32_t n) {
...
EbpfHelperPrototype get_helper_prototype_freebsd(int32_t n) {
    if (!is_helper_usable_freebsd(n))
        throw std::exception();
    return prototypes[n];
}
