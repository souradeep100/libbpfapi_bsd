...
cd ../..
cc src/service/common.cpp src/service/ebpf_verify_and_load_program.cpp src/service/ebpf_verify_program.cpp src/prototypes/bpf_svc_svc.c src/prototypes/bpf_svc_xdr.c -o .build/service/bpf_svc
